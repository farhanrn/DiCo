...
# Memperisapkan daily_orders_df dengan membuat create_daily_orders_df(df):
...
# Mempersiapkan sum_orders_items_df dengan create_sum_order_item_df
def create_sum_order_items_df(df):
    sum_order_items_df = df.groupby("product_name").quantity_x.sum().sort_values(ascending=False).reset_index()
    return sum_order_items_df

# Memperisapkan bygender_df dengan create_bygender_df()
...
# Mempersiapkan byage_df dengan membuat function create_byage_df()
...
# Mempersiapkan bystate_df dengan membaut functuon create_bystate_df()
...
# Mengurutkan dataftame berdasarkan order_date dan memastikan kedua 
# kolom bertipe datetime (order_date dan delivery_date)
...
# Melengkapi data dengan berbagai bentuk visualisasi data
st.header('Dicoding Collection Dashboard :sparkles:')

# Memberikan informasi terkait daily orders
...
# Produk terbaik dan terburuk dalam performa
